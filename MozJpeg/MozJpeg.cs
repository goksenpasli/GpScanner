...
namespace MozJpeg
{
    ...
    internal sealed class UnsafeNativeMethods
    {
        ...
        /// cref="TjAlloc"/> and let TurboJPEG grow the buffer as needed</description></item><item><description>set
        /// <paramref name="jpegBuf"/> to NULL to tell TurboJPEG to allocate the buffer for
            ...
            int flags)
        {
            ...
            {
                case 4:
                    return tjDecompressToYUVPlanes_x86(
                        handle,
                        jpegBuf,
                        (uint)jpegSize,
                        dstPlanes,
                ...
                case 8:
                    return tjDecompressToYUVPlanes_x64(
                        handle,
                        jpegBuf,
                        jpegSize,
                        dstPlanes,
        ...
        /// bounds.
        /// </returns>
        public static int TjPlaneSizeYUV(
            int componentID,
            int width,
            int stride,
            int height,
        ...
        private static extern int tjPlaneSizeYUV_x64(
            int componentID,
            int width,
            int stride,
            int height,
        ...
        private static extern int tjPlaneSizeYUV_x86(
            int componentID,
            int width,
            int stride,
            int height,
