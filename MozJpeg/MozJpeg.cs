...
namespace MozJpeg
{
    ...
    public class MozJpeg : IDisposable
    {
        ...
        /// <param name="flags">The bitwise OR of one or more of the <see cref="TJFlags"/> "flags"</param>
        /// <returns>Bitmap with image</returns>
        public void GetInfo(byte[] rawJpeg,
                            out int width,
                            out int height,
    ...
    internal sealed class UnsafeNativeMethods
    {
        ...
        public static int TjCompress2(IntPtr handle,
                                      IntPtr srcBuf,
                                      int width,
                                      int stride,
                                      int height,
        ...
        /// </param>
        /// <returns>0 if successful, or -1 if an error occurred (see <see cref="tjGetErrorStr"/>)</returns>
        public static int TjDecompressHeader(IntPtr handle,
                                             IntPtr jpegBuf,
                                             ulong jpegSize,
                                             out int width,
                                             out int height,
        ...
        private static extern int tjDecompressHeader3_x64(IntPtr handle,
                                                          IntPtr jpegBuf,
                                                          ulong jpegSize,
                                                          out int width,
                                                          out int height,
        ...
        private static extern int tjDecompressHeader3_x86(IntPtr handle,
                                                          IntPtr jpegBuf,
                                                          uint jpegSize,
                                                          out int width,
                                                          out int height,
