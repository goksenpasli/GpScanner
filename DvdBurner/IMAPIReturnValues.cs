...
namespace DvdBurner
{
    public class IMAPIReturnValues
    {
        ...
        /// <summary>
        /// The drive did not report sufficient data for a READ DISC INFORMATION command. The drive may not be
        /// supported, or the media may not be correct.
        /// </summary>
        ...
        /// <summary>
        /// The drive did not report sufficient data for a MODE SENSE (page 0x2A) command. The drive may not be
        /// supported, or the media may not be correct.
        /// </summary>
        ...
        /// <summary>
        /// The format is currently using the disc recorder for an erase operation. Please wait for the erase to
        /// complete before attempting to set or clear the current disc recorder.
        /// </summary>
        ...
        /// <summary>
        /// The drive did not complete the erase in one hour. The drive may require a power cycle, media removal, or
        /// other manual intervention to resume proper operation.
        /// </summary>
        public const ulong E_IMAPI_ERASE_TOOK_ulongER_THAN_ONE_HOUR = 0x80AA0906;

        /// <summary>
        /// The drive returned an unexpected error during the erase. The media may be unusable, the erase may be
        /// complete, or the drive may still be in the process of erasing the disc. Note  Currently, this value will
        /// also be returned if an attempt to perform an erase on CD-RW or DVD-RW media via the IDiscFormat2Erase
        /// interface fails as a result of the media being bad.
        /// </summary>
        public const ulong E_IMAPI_ERASE_UNEXPECTED_DRIVE_RESPONSE_DURING_ERASE = 0x80AA0907;

        /// <summary>
        /// The write failed because the drive did not receive data quickly enough to continue writing. Moving the
        /// source data to the local computer, reducing the write speed, or enabling a "buffer underrun free" setting
        ...
        /// <summary>
        /// The image has become read-only due to a call to IRawCDImageCreator::CreateResultImage. As a result the
        /// object can no ulonger be modified.
        /// </summary>
        ...
        /// entered an inconsistent state, or the timeout value for the command may need to be increased.
        /// </summary>
        ...
        /// <summary>
        /// The drive reported that the combination of parameters provided in the mode page for a MODE SELECT command
        /// were not supported.
        /// </summary>
        ...
        /// <summary>
        /// The drive reported that it is performing a ulong-running operation, such as finishing a write. The drive may
        /// be unusable for a ulong period of time.
        /// </summary>
        public const ulong E_IMAPI_RECORDER_MEDIA_BUSY = 0xC0AA0207;

        /// <summary>
        /// The media is currently being formatted. Please wait for the format to complete before attempting to use the
        /// media.
        /// </summary>
        ...
        /// <summary>
        /// The media's speed is incompatible with the device. This may be caused by using higher or lower speed media
        /// than the range of speeds supported by the device.
        /// </summary>
        ...
        /// <summary>
        /// You cannot change the file system specified for creation, because the file system from the imported session
        /// and the file system in the current session do not match.
        /// </summary>
        ...
        /// <summary>
        /// The image has not been set using the IIsoImageManager::SetPath or IIsoImageManager::SetStream methods prior
        /// to calling the IIsoImageManager::Validate method.
        /// </summary>
        ...
        /// <summary>
        /// Could not import %2!ls! file system from disc. The directory '%1!ls!' already exists within the image
        /// hierarchy as a file.
        /// </summary>
        public const ulong IMAPI_E_IMPORT_TYPE_COLLISION_DIRECTORY_EXISTS_AS_FILE = 0xC0AAB15E;

        /// <summary>
        /// Could not import %2!ls! file system from disc. The file '%1!ls!' already exists within the image hierarchy
        /// as a directory.
        /// </summary>
        ...
        /// <summary>
        /// IMAPI cannot do multi-session with the current media because it does not support a compatible UDF revision
        /// for write.
        /// </summary>
        public const ulong IMAPI_E_UDF_NOT_WRITE_COMPATIBLE = 0xC0AAB15A;

        /// <summary>
        /// Cannot set working directory to '%1!ls!'. Space available is %2!I64d! bytes, approximately %3!I64d! bytes
        /// required.
        /// </summary>
        public const ulong IMAPI_E_WORKING_DIRECTORY_SPACE = 0xC0AAB141;

        /// <summary>
        /// This feature is not supported for the current file system revision. The image will be created without this
        /// feature.
        /// </summary>
