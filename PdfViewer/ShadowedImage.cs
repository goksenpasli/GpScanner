...
{
    public static readonly DependencyProperty LocationProperty = DependencyProperty.Register("Location", typeof(Point), typeof(ShadowedImage), new FrameworkPropertyMetadata(new Point(2.5, 2.5), FrameworkPropertyMetadataOptions.AffectsRender));
    ...
    public static readonly DependencyProperty ShadowColorProperty = DependencyProperty.Register(
        ...
        new FrameworkPropertyMetadata(new SolidColorBrush(Color.FromArgb(70, 128, 128, 128)), FrameworkPropertyMetadataOptions.AffectsRender));
    ...
    public static readonly DependencyProperty ShowShadowProperty =
        DependencyProperty.Register("ShowShadow", typeof(bool), typeof(ShadowedImage), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.AffectsRender));
