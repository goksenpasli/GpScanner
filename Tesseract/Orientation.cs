namespace Tesseract
{
    ...
    ///     "up" aligns with Orientation, then the characters will appear "right side up" and readable. In short:
    ///     <list
    ///         type="bullet">
    ...
    ///         </item>
    ///         <item>
    ///             PageDown - Page needs to be rotated so the bottom side is up, 180 degress counter
    ///             clockwise, to be readable.
    ///         </item>
    ///         <item>
    ///             PageLeft - Page needs to be rotated so the left hand side is up, 90
    ///             degress clockwise, to be readable.
    ///         </item>
    ///     </list>
    /// </remarks>
