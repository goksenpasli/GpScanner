...
{
    /// <summary>
    /// The grapheme cluster within a line of text are laid out logically in this direction, judged when looking at the
    /// text line rotated so that Orientation is "page up".
    /// </summary>
