...
namespace Tesseract
{
    public sealed unsafe class Pix : DisposableBase, IEquatable<Pix>
    {
        ...
        ///     memory leaks. The general usage protocol is:
        ///     <list type="number">
        ///         <item>
        ///             Whenever you want a new reference to
        ///             an existing <see cref="Pix" /> call <see cref="Clone" />.
        ///         </item>
        ///         <item>
        ///             Always call <see cref="Dispose" /> on all
        ...
        /// <remarks>
        ///     <para>
        ///         This function scales 32 bpp RGB; 2, 4 or 8 bpp palette color; 2, 4, 8 or 16 bpp gray; and binary
        ///         images.
        ///     </para>
        ///     <para>
        ///         When the input has palette color, the colormap is removed and the result is either 8
        ///         bpp gray or 32 bpp RGB, depending on whether the colormap has color entries.  Images with 2, 4 or 16 bpp are
        ///         converted to 8 bpp.
        ///     </para>
        ///     <para>
        ///         Because Scale() is meant to be a very simple interface to a number of
        ...
        ///             <item>
        ///                 <description>
        ///                     linear interpolation with sharpening, for scale
        ///                     factors between 0.7 and 1.4.
        ///                 </description>
        ///             </item>
        ///             <item>
        ///                 <description>
        ///                     linear interpolation without sharpening,
        ///                     for scale factors >= 1.4.
        ///                 </description>
        ///             </item>
        ///         </list>
        ///         One could use subsampling for scale factors very close
        ...
        ///     </para>
        ///     <para>
        ///         For images with sharp edges, sharpening substantially improves the image
        ...
        ///         <list type="bullet">
        ///             <item>
        ///                 <description><![CDATA[for scaling factors < 0.7:   sharpfract = 0.2
        /// sharpwidth = 1]]></description>
        ///             </item>
        ///             <item>
        ///                 <description>
        ///                     for scaling factors >= 0.7:  sharpfract = 0.4
        ///                     sharpwidth = 2
        ///                 </description>
        ///             </item>
        ///         </list>
        ...
        ///     </para>
        ///     <para>
        ///         However, sharpening is
        ///         computationally expensive, and one needs to consider the speed-quality tradeoff:
        ///         <list
        ///             type="bullet">
        ///             <item>
        ///                 <description>
        ///                     For upscaling of RGB images, linear interpolation plus default sharpening
        ///                     is about 5 times slower than upscaling alone.
        ///                 </description>
        ///             </item>
        ///             <item>
        ///                 <description>
        ///                     For downscaling, area
        ///                     mapping plus default sharpening is about 10 times slower than downscaling alone.
        ///                 </description>
        ///             </item>
        ///         </list>
        ...
        ///         1.4.  Thus, for scale factors greater than 1.4, pixScale() only does linear interpolation.
        ///     </para>
        ///     <para>
        ///         In
        ...
        ///     </para>
        ///     <para>
        ///         Binary images are scaled to binary by sampling the closest pixel, without any low-pass filtering
        ///         (averaging of neighboring pixels). This will introduce aliasing for reductions.  Aliasing can be prevented
        ///         by using pixScaleToGray() instead.
        ///     </para>
        ///     <para>
        ///         Warning: implicit assumption about RGB component order for
        ///         LI color scaling
        ///     </para>
        /// </remarks>
        ...
        {
            return other != null && (LeptonicaApi.Native.pixEqual(Handle, other.Handle, out int same) != 0
        ...
        public Pix BinarizeOtsuAdaptiveThreshold(int sx, int sy, int smoothx, int smoothy, float scorefract)
        {
            ...
            int result = LeptonicaApi.Native.pixOtsuAdaptiveThreshold(handle, sx, sy, smoothx, smoothy, scorefract,
                out IntPtr ppixth, out IntPtr ppixd);
        ...
        ///         <item>
        ///             The window width and height are 2 *
        ///             <paramref
        ///                 name="whsize" />
        ///             + 1. The minimum value for<paramref name="whsize" /> is 2; typically it is >=
        ///             7.
        ///         </item>
        ///         <item>
        ///             The local statistics, measured over the window, are the average and standard
        ///             deviation.
        ///         </item>
        ///         <item>
        ///             The measurements of the mean and standard deviation are performed inside a border of
        ///             (<paramref name="whsize" /> + 1) pixels. If source pix does not have these added border pixels, use
        ///             <paramref
        ///                 name="addborder" />
        ///             = <c>True</c> to add it here; otherwise use<paramref name="addborder" />
        ///             =<c>False</c>.
        ///         </item>
        ///         <item>
        ///             The Sauvola threshold is determined from the formula:  t = m * (1 - k * (1 - s /
        ///             128)) where t = local threshold, m = local mean, k = <paramref name="factor" />, and s = local standard
        ///             deviation which is maximised at 127.5 when half the samples are 0 and the other half are 255.
        ///         </item>
        ///         <item>
        ...
        {
            IntPtr resultPixHandle = LeptonicaApi.Native.pixDeskewGeneral(handle, sweep.Reduction, sweep.Range,
                sweep.Delta, redSearch, thresh, out float pAngle, out float pConf);
        ...
        public Pix Despeckle(string selStr, int selSize)
        {
            ...
            pix5 = LeptonicaApi.Native.pixDilate(new HandleRef(this, IntPtr.Zero), new HandleRef(this, pix4),
                new HandleRef(this, sel2));
            pix6 = LeptonicaApi.Native.pixSubtract(new HandleRef(this, IntPtr.Zero), new HandleRef(this, pix3),
        ...
        ///     <code>lineremoval.c</code> example. See
        ///     <a href="http://www.leptonica.com/line-removal.html">
        ///         line-
        ///         removal
        ///     </a>
        ///     .
        ...
        public Pix RemoveLines()
        {
            ...
            try
            {
                ...
                _ = LeptonicaApi.Native.pixCombineMasked(new HandleRef(this, pix8), new HandleRef(this, pix9),
        ...
        ///     <list type="bullet">
        ///         <item>
        ///             Rotation will bring in either white or black pixels, as
        ///             specified by <paramref name="fillColor" /> from the outside as required.
        ///         </item>
        ///         <item>
        ///             Above 20 degrees,
        ///             sampling rotation will be used if shear was requested.
        ///         </item>
        ///         <item>
        ///             Colormaps are removed for rotation by
        ///             area map and shear.
        ///         </item>
        ///         <item>
        ///             The resulting image can be expanded so that no image pixels are lost. To
        ...
        ///         </item>
        ///     </list>
        ///     <para>Please note there is an implicit assumption about RGB component ordering.</para>
        /// </remarks>
