    ...
    public class CustomScrollControl : Control
    {
        ...
        protected override void OnMouseWheel(MouseEventArgs e)
        {
            ...
            else if (HScroll)
            {
                ...
                if (e is HandledMouseEventArgs handledMouseEventArgs2)
                {
                    handledMouseEventArgs2.Handled = true;
                }
            }
        ...
        private bool ApplyScrollbarChanges()
        {
            ...
            {
                _ = SetDisplayRectangleSize(maxX, maxY);
            }
        ...
        private int ScrollThumbPosition(int fnBar)
        {
            ...
            _ = NativeMethods.GetScrollInfo(new HandleRef(this, Handle), fnBar, si);
        ...
        private void SetDisplayRectLocation(int x, int y, bool preserveContents)
        {
            ...
            if ((xDelta != 0 || yDelta != 0) && IsHandleCreated && preserveContents)
            {
                ...
                _ = NativeMethods.ScrollWindowEx(
        ...
        {
            bool needLayout = (horiz ^ HScroll) || (!vert && VScroll) || (vert && !VScroll);
        ...
        private class ScrollProperties
        {
            ...
            public int LargeChange {
                get => Math.Min(_largeChange, Maximum + 1);
            ...
            public void UpdateScrollInfo()
            {
                ...
                _ = NativeMethods.SetScrollInfo(new HandleRef(_parentControl, _parentControl.Handle), _orientation, si, true);
            }
