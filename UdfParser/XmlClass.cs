...
public class Content
{
    ...
    [XmlAttribute(AttributeName = "bold")] public bool Bold { get; set; }
...
{
    [XmlElement(ElementName = "footer")] public Footer Footer { get; set; }
...
public class Paragraph
{
    ...
    [XmlElement(ElementName = "content")] public List<Content> Content { get; set; }
...
{
    [XmlElement(ElementName = "bgImage")] public BgImage BgImage { get; set; }
...
public class Row
{
    [XmlElement(ElementName = "cell")] public List<Cell> Cell { get; set; }
...
public class Styles
{
    [XmlElement(ElementName = "style")] public List<Style> Style { get; set; }
}
...
public class Template
{
    ...
    [XmlElement(ElementName = "elements")] public Elements Elements { get; set; }
    ...
    [XmlElement(ElementName = "styles")] public Styles Styles { get; set; }
