...
public static class UdfParser
{
    public static IDocumentPaginatorSource RenderDocument(Template content)
    {
        ...
        flowdocumentscrollviewer.Document.PagePadding = new Thickness(pageformat.LeftMargin * 4 / 3,
            pageformat.TopMargin * 4 / 3, pageformat.RightMargin * 4 / 3, pageformat.BottomMargin * 4 / 3);
