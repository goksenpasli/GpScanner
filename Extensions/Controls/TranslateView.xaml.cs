...
public partial class TranslateView : UserControl
{
    ...
    public bool DestLangIsEnabled { get => (bool)GetValue(DestLangIsEnabledProperty); set => SetValue(DestLangIsEnabledProperty, value); }

    public bool SourceLangIsEnabled { get => (bool)GetValue(SourceLangIsEnabledProperty); set => SetValue(SourceLangIsEnabledProperty, value); }
}