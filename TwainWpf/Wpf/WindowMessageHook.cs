...
namespace TwainWpf.Wpf
{
    public class WindowMessageHook : IWindowsMessageHook
    {
        ...
        public IntPtr FilterMessage(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref bool handled) => FilterMessageCallback is null ? IntPtr.Zero : FilterMessageCallback(hwnd, msg, wParam, lParam, ref handled);
    }
}