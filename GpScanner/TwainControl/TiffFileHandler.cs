...
namespace TwainControl
{
    public class TiffFileHandler : ILoadFileHandler
    {
        ...
        public bool IsValidFile(string filename) => filename.EndsWith(".tiff", StringComparison.OrdinalIgnoreCase) || filename.EndsWith(".tif", StringComparison.OrdinalIgnoreCase);
