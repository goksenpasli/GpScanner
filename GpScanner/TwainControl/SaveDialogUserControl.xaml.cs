...
public partial class SaveDialogUserControl : UserControl, INotifyPropertyChanged
{
    ...
    { PreviewImage = twainCtrl.SaveIndex == 3 ? twainCtrl?.SeçiliResim?.Resim?.Resize(512, 512).BitmapSourceToBitmap().ConvertBlackAndWhite(Settings.Default.BwThreshold).ToBitmapImage(ImageFormat.Jpeg) : null; }
