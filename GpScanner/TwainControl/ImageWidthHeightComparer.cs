...
public partial class TwainCtrl
{
    ...
    {
        public bool Equals(ScannedImage x, ScannedImage y) => (x == null && y == null) ||
        (x != null && y != null && x.Resim.PixelHeight == y.Resim.PixelHeight && x.Resim.PixelWidth == y.Resim.PixelWidth);
