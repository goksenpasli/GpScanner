...
public sealed class StringToQrBitmapImageConverter : IValueConverter
{
    ...
    public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture) => value is WriteableBitmap bitmapImage ? qrcode.GetImageBarcodeResult(BitmapFrame.Create(bitmapImage.ToBitmapImage())) : null;
}