...
public class AllPdfViewerControl : DependencyObject
{
    ...
    public static readonly DependencyProperty AllPageOrientationProperty = DependencyProperty.RegisterAttached(
        "AllPageOrientation",
        typeof(FitImageOrientation),
        typeof(AllPdfViewerControl),
        new PropertyMetadata(FitImageOrientation.Width, FitImageOrientationChanged));
    ...
    public static FitImageOrientation GetAllPageOrientation(DependencyObject obj) => (FitImageOrientation)obj.GetValue(AllPageOrientationProperty);
    ...
    public static void SetAllPageOrientation(DependencyObject obj, FitImageOrientation value) => obj.SetValue(AllPageOrientationProperty, value);
    ...
    private static void FitImageOrientationChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        if (d is PdfViewer.PdfViewer pdfviewer)
        {
            pdfviewer.Orientation = (FitImageOrientation)e.NewValue;
        }
    }
