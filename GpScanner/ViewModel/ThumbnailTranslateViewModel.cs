...
{
    public static readonly DependencyProperty AttachedTextProperty = DependencyProperty.RegisterAttached("AttachedText",
        typeof(string), typeof(ThumbnailTranslateViewModel), new PropertyMetadata(null, AttachedTextChanged));
